...
public class CardTransactionHistoryHandler implements RequestHandler<TransactionHistory, String>{
	...
	public String handleRequest(TransactionHistory input, Context context) {
		...
		final AmazonDynamoDB dynamoDB = AmazonDynamoDBClientBuilder.standard().withClientConfiguration(clientConfig).withRegion(Regions.AP_SOUTH_1).build();
        ...
        Condition txnDateCondition = new Condition()
        ...
        scanFilter.put("transactionDate", txnDateCondition);
